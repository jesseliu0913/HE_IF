...
def create_voronoi_graph(cell_features, cell_coords, max_distance=50, memory_efficient=True, 
    ...
    if cache_path and cache_id:
        cache_file = f"{cache_path}/voronoi_naive_graph_cache_{cache_id}.pkl"
...
def main():
    data_path = "./cell_feature_naive"  # Path to your new feature data
    cell_ids, features, coords, data_splits = load_cell_features(data_path)
    
    csv_file = "/playpen/jesse/HE_IF/graph_comparison/cell_feature_naive/CRC03_new_coordinates.csv"  # Updated file path
    ...
    cache_dir = "./graph_cache_voronoi_naive"  # Updated cache directory
    ...
    output_dir = "voronoi_naive_gnn_results"  # Updated output directory
    epochs = 50
    patience = 15
    lr = 0.001
    weight_decay = 1e-5
...
# CUDA_VISIBLE_DEVICES=4 nohup python voronoi_raw.py > voronoi_raw.log 2>&1 &