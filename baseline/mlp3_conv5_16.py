...
def train_evaluation_pipeline(data_directory, biomarkers, num_epochs=5):
    ...
    for epoch in range(num_epochs):
        ...
        if val_loss < best_val_loss:
            ...
            }, os.path.join(output_directory, "model_results_m3c5", "biomarker_model_m3c5.pt"))
        
        print(f"Epoch {epoch+1}/{num_epochs} - Train Loss: {train_loss:.4f}, Val Loss: {val_loss:.4f}")
    
    checkpoint = torch.load(os.path.join(output_directory, "model_results_m3c5", "biomarker_model_m3c5.pt"))
    ...
    output_dir = os.path.join(output_directory, "model_results_m3c5")
